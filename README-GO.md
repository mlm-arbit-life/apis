...
```bash
export MLMBOX_API_PATH="$HOME/go/src/github.com/mlm-arbit-life/apis"
...
protoc -I $MLMBOX_API_PATH --go_out=. --go_opt=Mmlmbox/type/asset_pair.proto=mlmbox/type/asset_pair mlmbox/type/asset_pair.proto
...
protoc -I $MLMBOX_API_PATH --go_out=. --go_opt=Mmlmbox/type/exchanger.proto=mlmbox/type/exchanger mlmbox/type/exchanger.proto
...
protoc -I $MLMBOX_API_PATH --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative mlmbox/client/asset_pair/v1/asset_pair.proto
...
protoc -I $MLMBOX_API_PATH --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative mlmbox/client/google_authenticator/v1/google_authenticator.proto
...
protoc -I $MLMBOX_API_PATH --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative mlmbox/local/asset_pair/asset_pair.proto
